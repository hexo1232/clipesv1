...
<title>ObsidianPlay — Premium Video Experience</title>
...
body {
    min-height: 100vh;
    background:
        radial-gradient(circle at 15% 5%, rgba(139,92,246,0.32), transparent 34%),
...
.topbar {
    ...
    left: 0;
    width: 100%;
    background: linear-gradient(180deg, rgba(6,6,10,0.90), rgba(6,6,10,0.30));
...
.hero-bg::before {
    ...
    inset: 0;
    background:
        linear-gradient(90deg, #060608 0%, rgba(6,6,8,0.96) 24%, rgba(6,6,8,0.60) 54%, rgba(6,6,8,0.92) 100%),
        linear-gradient(180deg, transparent 0%, #060608 100%);
    z-index: 2;
}
...
.hero-bg::after {
    ...
    inset: 0;
    background:
        radial-gradient(circle at 78% 30%, rgba(139,92,246,0.34), transparent 28%),
        radial-gradient(circle at 70% 20%, rgba(255,184,77,0.16), transparent 20%);
    z-index: 3;
}
...
.hero-fallback {
    ...
    height: 100%;
    background:
        linear-gradient(135deg, rgba(139,92,246,0.35), rgba(255,184,77,0.10)),
...
.hero-title span {
    color: var(--red);
    text-shadow: 0 0 44px rgba(139,92,246,0.55);
}
...
.no-thumb {
    ...
    place-items: center;
    background:
        radial-gradient(circle, rgba(139,92,246,0.20), transparent 38%),
        linear-gradient(135deg, #17171f, #0a0a0d);
}
